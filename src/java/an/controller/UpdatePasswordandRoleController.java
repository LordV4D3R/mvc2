 ...
 * @author tranq
 */
@WebServlet(name = "UpdatePasswordandRoleController", urlPatterns = {"/UpdatePasswordandRoleController"})
public class UpdatePasswordandRoleController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean result = dao.updateAccount(username, password, newRole);
